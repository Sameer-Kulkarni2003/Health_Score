...
condition_reasons = {
    ...
    "anemia": "results from low red blood cell count, leading to fatigue and weakness.",
    "depression": "affects mood, causing persistent sadness, loss of interest, and physical symptoms.",
    "anxiety": "can lead to excessive worry, tension, and physical symptoms such as heart palpitations.",
    "obesity": "increases the risk of many health conditions, including heart disease, diabetes, and joint problems.",
    "osteoporosis": "weakens bones, increasing the risk of fractures.",
    "multiple sclerosis": "is an autoimmune disorder that affects nerve function, leading to physical and cognitive issues.",
}
